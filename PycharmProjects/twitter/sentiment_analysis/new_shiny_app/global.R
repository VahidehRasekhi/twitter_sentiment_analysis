...
#reading data
total_countries <- read_csv('data/total_country.csv') 
total_cities <- read_csv('data/total_city.csv') 
total_subcountries <- read_csv('data/total_subcountry.csv')
#compound_sentiment<- read_csv('compound_sentiment.csv')
US_states_codes<-read_csv('data/US_states_codes.csv')#, header=TRUE, sep=",")




neg_wordcloud<-read_csv('data/combined_neg.csv')
pos_wordcloud<- read_csv('data/combined_pos.csv')
